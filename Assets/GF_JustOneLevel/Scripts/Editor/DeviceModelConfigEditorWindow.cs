...
namespace Editor {
    public class DeviceModelConfigEditorWindow : EditorWindow {
        ...
        [MenuItem ("GF JustOneLevel/Device Model Config Editor")]
        public static void EditDeviceModelConfig () {
            const string DeviceModelConfigFullName = "Assets/GF_JustOneLevel/Configs/DeviceModelConfig.asset";
            Debug.Log("EditDeviceModelConfig:" + DeviceModelConfigFullName);
        ...
        public static void OpenWindow (DeviceModelConfig deviceModelConfig) {
            Debug.Log("OpenWindow:" + deviceModelConfig);
